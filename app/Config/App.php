...
class App extends BaseConfig {
     ...
     * --------------------------------------------------------------------------
     *
     * The Locale roughly represents the language and location that our Twilions
     * are viewing the site from. It affects the language strings and other
     * strings (like currency markers, numbers, etc), that TOPS
     ...
     * --------------------------------------------------------------------------
     *
     * The default timezone that will be used in TOPS Platform to display
    ...
    /* User configs */
    public $encryption_key = "2aeb7cb50577e1a";
