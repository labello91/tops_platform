 ...
 */
 ...
 class App_Controller extends Controller {
    ...
    public function __construct() {
        ...
        $this->session = \Config\Services::sessions();
    ...
    private function get_models_array() {
        return array(
            ...
            'Forecast_model',
            'Forecast_items_model',
            'Forecast_vs_ytd_model',
    ...
    protected function validate_submitted_data($fields = array(), $return_errors = false) {
        ...
        if (!$final_fields) {
            //no fields to validate in ths context, so nothing to validate
            return true;
        }
        ...
        if (!$validate) {
            ...
            echo json_encode(array("success" => false, 'message' => json_enconde($message)));
            exit();
        }
    }
