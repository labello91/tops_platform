    ...
    private function _templates() {
        $templates_array = array(
            "account" => array(
                ...
                "new_bu_greetings" => array("CONTACT_FIRST_NAME", "CONTACT_LAST_NAME", "BU_NAME", "DASHBOARD_URL", "CONTACT_LOGIN_EMAIL", "CONTACT_LOGIN_PASSWORD", "LOGO_URL", "SIGNATURE"),
                "bu_contact_invitation" => array("INVITATION_SENT_BY", "INVITATION_URL", "SITE_URL", "LOGO_URL", "SIGNATURE"),
            ...
            "forecast" => array(
                "send_forecast" => array("FORECAST_ID", "CONTACT_FIRST_NAME", "CONTACT_LAST_NAME", "PROJECT_TITLE", "BALANCE_DUE", "DUE_DATE", "SIGNATURE", "FORECAST_URL", "LOGO_URL", "PUBLIC_PAY_FORECAST_URL"),
                "forecast_ytd_actual_confirmation" => array("FORECAST_ID", "YTD_ACTUAL_AMOUNT", "FORECAST_URL", "LOGO_URL", "SIGNATURE"),
                "forecast_due_reminder_before_due_date" => array("FORECAST_ID", "CONTACT_FIRST_NAME", "CONTACT_LAST_NAME", "PROJECT_TITLE", "BALANCE_DUE", "DUE_DATE", "SIGNATURE", "FORECAST_URL", "LOGO_URL"),
                "forecast_overdue_reminder" => array("FORECAST_ID", "CONTACT_FIRST_NAME", "CONTACT_LAST_NAME", "PROJECT_TITLE", "BALANCE_DUE", "DUE_DATE", "SIGNATURE", "FORECAST_URL", "LOGO_URL"),
                "recurring_forecast_creation_reminder" => array("CONTACT_FIRST_NAME", "CONTACT_LAST_NAME", "APP_TITLE", "FORECAST_URL", "NEXT_RECURRING_DATE", "LOGO_URL", "SIGNATURE"),
            ),
            "ticket" => array(
            ...
            "common" => array(
                "general_notification" => array("EVENT_TITLE", "EVENT_DETAILS", "APP_TITLE", "BU_NAME", "NOTIFICATION_URL", "LOGO_URL", "SIGNATURE"),
                "signature" => array()
            )
        );
