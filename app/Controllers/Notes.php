...
class Notes extends Security_Controller {
    ...
    protected function validate_access_to_note($note_info, $edit_mode = false) {
        if ($note_info->is_public) {
            ...
            if ($note_info->bu_id) {
                //this is a bu´s note. check bu access permission
                $access_info = $this->get_access_info("bu");
    ...
    function modal_form() {
        ...
        $view_data['bu_id'] = $this->request->getPost('bu_id') ? $this->request->getPost('bu_id') : $view_data['model_info']->bu_id;
    ...
    function save() {
        ...
        $data = array(
            ...
            "bu_id" => $this->request->getPost('bu_id') ? $this->request->getPost('bu_id') : 0,
