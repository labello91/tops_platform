...
class roles extends Security_Controller {
    ...
    function modal_form() {
        ...
        return $this->template->view('roles_modal_form', $view_data);
    }
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['forecast'] = get_array_value($permissions, "forecast");
            $view_data['actuals'] = get_array_value($permissions, "actuals");
            $view_data['bu'] = get_array_value($permissions, "bu");
            $view_data['intake'] = get_array_value($permissions, "intake");
    ...
    function save_permissions() {
        ...
        $forecast = $this->request->getPost('forecast_permission');
        $actuals = $this->request->getPost('actuals_permission');
        $bu = $this->request->getPost('bu_permission');
        $intake = $this->request->getPost('intake_permission');
