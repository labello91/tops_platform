...
class Team_members extends Security_Controller {
    ...
    function view($id = 0, $tab = "") {
        if ($id * 1) {
            ...
            $options = array("id" => $id, "user_type" => "team_member");
            ...
            if ($user_info) {
                ...
                $view_data["show_actuals_info"] = (get_setting("module_actuals") == "1" && $actuals_access_info->access_type == "all") ? true : false;
            ...
            $view_data['team_members'] = $this->Users_model->get_details(array("user_type" => "team_member", "status" => "active"))->getResult();
