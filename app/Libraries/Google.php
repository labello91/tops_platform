...
class Google {
    ...
    public function authorize() {
        $bu = $this->_get_bu_credentials();
        $this->_check_access_token($bu, true);
    }

    //check access token
    private function _check_access_token($bu, $redirect_to_settings = false) {
    ...
    private function _get_drive_service() {
        $bu = $this->_get_bu_credentials();
        $this->_check_access_token($bu);

        return new \Google_Service_Drive($bu);
    }
    ...
    //get bu credentials
    private function _get_bu_credentials() {
        $url = get_uri("google_api/save_access_token");

        $bu = new \Google_bu();
        $bu->setApplicationName(get_setting('app_title'));
        $bu->setRedirectUri($url);
        $bu->setbuId(get_setting('google_drive_bu_id'));
        $bu->setBUSecret(get_setting('google_drive_bu_secret'));
        $bu->setScopes(\Google_Service_Drive::DRIVE);
