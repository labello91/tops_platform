...
class Custom_field_values_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $show_in_forecast = get_array_value($options, "show_in_forecast");
        if ($show_in_forecast) {
            $where .= " AND $custom_fields_table.show_in_forecast=1";
        }
    ...
    private function upsert_custom_field($data, $save_to_related_type = "") {
        ...
        $data = array(
            ...
            "show_in_forecast" => $custom_field_info->show_in_forecast,
            "visible_to_admins_only" => $custom_field_info->visible_to_admins_only,
            "hide_from_bu" => $custom_field_info->hide_from_bu,
            "deleted" => 0
        );
