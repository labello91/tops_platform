...
class Notification_settings_model extends Crud_model {
    ...
    function notify_to_terms() {
        return array(
            "team_members", "team", "project_members", "bu_primary_contact", "bu_all_contacts", "task_assignee", "task_collaborators", "comment_creator", "staff_feedback_creator", "ticket_creator", "ticket_assignee", "recipient", "mentioned_members", "owner", "bu_assigned_contacts", "post_creator"
        );
    }
