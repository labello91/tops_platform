...
class Project_comments_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        if ($project_id) {
            $where .= " AND $project_comments_table.project_id=$project_id AND $project_comments_table.task_id=0 AND $project_comments_table.file_id=0 and $project_comments_table.staff_feedback_id=0";
        }
        ...
        $staff_feedback_id = get_array_value($options, "staff_feedback_id");
        if ($staff_feedback_id) {
            $where .= " AND $project_comments_table.staff_feedback_id=$staff_feedback_id";
        }
    ...
    function save_comment($data) {
        ...
        $staff_feedback_id = get_array_value($data, "staff_feedback_id");
        ...
        if ($comment_id) {
            ...
            } else if ($comment_info->staff_feedback_id) {
                $data["staff_feedback_id"] = $comment_info->staff_feedback_id;
                $type = "staff_feedback";
                $type_id = "staff_feedback_id";
                $reply_type = "staff_feedback_reply";
            }
        ...
        } else if ($staff_feedback_id) {
            $data["project_id"] = $staff_feedback_id;
            parent::init_activity_log("staff_feedback", "description", "project", "project_id", "staff_feedback", "staff_feedback_id");
        }
