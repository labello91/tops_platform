...
class Projects_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        if ($bu_id) {
            $where .= " AND $projects_table.bu_id=$bu_id";
        }
        ...
        if (!$bu_id && $user_id && !$starred_projects) {
        ...
        $sql = "SELECT $projects_table.*, $bu_table.bu_name, $bu_table.currency_symbol,  total_points_table.total_points, completed_points_table.completed_points, $select_labels_data_query $select_custom_fieds
        FROM $projects_table
        LEFT JOIN $bu_table ON $bu_table.id= $projects_table.bu_id
