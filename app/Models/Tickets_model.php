...
class Tickets_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        if ($bu_id) {
            $where .= " AND $tickets_table.bu_id=$bu_id";
        }
        ...
        if ($status === "closed") {
            ...
            $where .= " AND FIND_IN_SET($tickets_table.status, 'new,open,bu_replied')";
        }
        ...
        $sql = "SELECT $tickets_table.*, $ticket_types_table.title AS ticket_type, $bu_table.company_name, $project_table.title AS project_title, $task_table.title AS task_title,
        ...
        LEFT JOIN $bu_table ON $bu_table.id= $tickets_table.bu_id
