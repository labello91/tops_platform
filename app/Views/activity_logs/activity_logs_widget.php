            ...
            <div class="p-2 w-100">
                <div class="card-title">
                    ...
                    if ($log->created_by_user) {
                        if ($log->user_type === "team_member") {
                            echo get_team_member_profile_link($log->created_by, $log->created_by_user, array("class" => "dark strong"));
                        } else {
                            echo get_bu_contact_profile_link($log->created_by, $log->created_by_user, array("class" => "dark strong"));
                        }
                ...
                <?php if ($log->log_for2 && $log->log_for2 != "staff_feedback") { ?>
                    <p> <?php
