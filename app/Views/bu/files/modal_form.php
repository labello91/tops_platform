<?php echo form_open(get_uri("bu/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="bu_id" value="<?php echo $bu_id; ?>" />
        <?php
        echo view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("bu/upload_file"),
            "validation_url" => get_uri("bu/validate_file"),
        ));
        ?>
    </div>
</div>
