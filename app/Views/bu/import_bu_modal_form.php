<?php echo form_open(get_uri("bu/save_bu_from_excel_file"), array("id" => "import-bu-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-bu-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("bu/upload_excel_file"),
                "validation_url" => get_uri("bu/validate_import_bu_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("bu/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var $uploadArea = $("#upload-area"),
                ...
                $modalBody = $(".import-bu-modal-body"),
        ...
        $nextButton.click(function () {
            ...
            appLoader.show({container: ".import-bu-modal-body", css: "left:0;"});
            var $button = $(this);
            ...
            $.ajax({
                url: "<?php echo get_uri('bu/validate_import_bu_file_data') ?>",
                type: 'POST',
                dataType: 'json',
