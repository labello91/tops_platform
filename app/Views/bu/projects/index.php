<?php if (isset($page_type) && $page_type === "full") { ?>
    ...
    <div class="card rounded-0">
            ...
            <div class="page-title clearfix">
                ...
                <div class="title-button-group">
                    ...
                    if (isset($can_create_projects) && $can_create_projects) {
                        echo modal_anchor(get_uri("projects/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_project'), array("class" => "btn btn-default", "data-post-bu_id" => $bu_id, "title" => app_lang('add_project')));
                    }
                    ?>
                </div>
            </div>
        ...
        <div class="table-responsive" id="bu-projects-list">
...
?>" || 0;
        ...
        if ("<?php echo get_setting("bu_can_edit_projects"); ?>") {
            optionVisibility = true;
        }


        $("#project-table").appTable({
            source: '<?php echo_uri("projects/projects_list_data_of_bu/" . $bu_id) ?>',
            order: [[0, "desc"]],
            hideTools: hideTools,
            multiSelect: [
                {
                    ...
                    options: [
                        ...
                        {text: '<?php echo app_lang("in_progress") ?>', value: "in_progress"},
            ...
            columns: [
                ...
                {title: '<?php echo app_lang("cost") ?>', "class": "w10p"},
