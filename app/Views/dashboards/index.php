    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php
                    if ($show_forecast_statistics) {
                        echo forecast_statistics_widget();
                    }
                    ?> 
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-12 widget-container">
                    <?php
                    if ($show_forecast_vs_actuals) {
                        echo forecast_vs_actuals_widget();
                    } else {
                        echo my_task_status_widget();
                    }
                    ?>
                </div>
            </div>
