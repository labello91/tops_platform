...
?>
<div id="page-content<?php echo $bu; ?>" class="page-wrapper<?php echo $bu; ?> clearfix">
    <div class="card mb0">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group custom-toolbar">
                ...
                <?php echo modal_anchor(get_uri("events/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_event'), array("class" => "btn btn-default add-btn", "title" => app_lang('add_event'), "data-post-bu_id" => $bu)); ?>

                <?php echo modal_anchor(get_uri("events/modal_form"), "", array("class" => "hide", "id" => "add_event_hidden", "title" => app_lang('add_event'), "data-post-bu_id" => $bu)); ?>
                <?php echo modal_anchor(get_uri("events/view"), "", array("class" => "hide", "id" => "show_event_hidden", "data-post-bu_id" => $bu, "data-post-cycle" => "0", "data-post-editable" => "1", "title" => app_lang('event_details'))); ?>
...
<script type="text/javascript">
    ...
    var loadCalendar = function () {
        ...
        window.fullCalendar = new FullCalendar.Calendar($eventCalendar, {
            ...
            events: "<?php echo_uri("events/calendar_events/"); ?>" + filter_values + "/" + event_label + "/" + "<?php echo "/$bu"; ?>",
            dayMaxEvents: false,
