<div class="modal-body">
    <div class="container-fluid">
        <div class="row mb15">
            ...
            <?php if ($model_info->bu_name && $login_user->user_type != "bu") { ?>
                <div class="col-md-12 pb10 pt10 ">
                    <i data-feather="<?php echo $model_info->is_intake ? "box" : "briefcase"; ?>" class="icon-16"></i>
                    <?php
                    echo $model_info->is_intake ? anchor("intake/view/" . $model_info->bu_id, $model_info->bu_name) : anchor("bu/view/" . $model_info->bu_id, $model_info->bu_name);
                    ?>
                </div>
            <?php } ?>
