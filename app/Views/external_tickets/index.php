<style type="text/css">
    ...
    .bu-info-section  .form-group {margin: 25px 15px;}
...
<div id="page-content" class="page-wrapper clearfix">
    <div id="external-ticket-form-container">
        ...
        <div id="new-ticket-dropzone" class="card p15 no-border clearfix post-dropzone bu-info-section" style="max-width: 1000px; margin: auto;">
