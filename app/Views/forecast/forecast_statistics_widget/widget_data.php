<div class="card bg-white">
    <div class="card-header clearfix">
        <i data-feather="file-text" class="icon-16"></i>&nbsp; <?php echo app_lang("forecast_statistics"); ?>

        <?php if ($currencies && $login_user->user_type == "team_member") { ?>
            <div class="float-end">
    ...
    <div class="card-body rounded-bottom">
        <canvas id="forecast-actuals-statistics-chart" style="width: 100%; height: 300px;"></canvas>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var forecastActualsChart = document.getElementById("forecast-actuals-statistics-chart");
