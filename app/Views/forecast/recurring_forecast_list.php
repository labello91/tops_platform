<div class="table-responsive">
    <table id="recurring-forecast-table" class="display" cellspacing="0" width="100%">   
    </table>
</div>
<script type="text/javascript">
    ...
    $("#recurring-forecast-table").appTable({
    source: '<?php echo_uri("forecast/recurring_list_data") ?>',
            order: [[0, "desc"]],
