    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-lg-0">
                ...
                if (!in_array("favorite_projects", $hidden_topbar_menus) && !(get_setting("disable_access_favorite_project_option_for_bu") && $login_user->user_type == "bu")) {
                    echo view("projects/star/topbar_icon");
                }
                if (!in_array("favorite_bu", $hidden_topbar_menus)) {
                    echo view("bu/star/topbar_icon");
                }
            ...
            <div class="d-flex w-auto">
                <ul class="navbar-nav">
                    ...
                    <?php if (!in_array("language", $hidden_topbar_menus) && (($login_user->user_type == "team_member" && !get_setting("disable_language_selector_for_team_members")) || ($login_user->user_type == "bu" && !get_setting("disable_language_selector_for_bu")))) { ?>
                                ...
                                <li>
                                    ...
                                    foreach (get_language_list() as $language) {
                                        ...
                                        if ($login_user->user_type == "team_member") {
                                            ...
                                            echo ajax_anchor(get_uri("bu/save_personal_language/$language"), $language_text . $language_status, array("class" => "dropdown-item clearfix", "data-reload-on-success" => "1"));
                                        }
                                    }
                                    ?>
                                </li>
                    ...
                    <?php if (get_setting("module_message") && can_access_messages_module()) { ?>
                        <li class="nav-item dropdown hidden-sm <?php echo ($login_user->user_type === "bu" && !get_setting("bu_message_users")) ? "hide" : ""; ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end w200">
                            <?php if ($login_user->user_type == "bu") { ?>
                                <li><?php echo get_bu_contact_profile_link($login_user->id . '/general', "<i data-feather='user' class='icon-16 me-2'></i>" . app_lang('my_profile'), array("class" => "dropdown-item")); ?></li>
                                <li><?php echo get_bu_contact_profile_link($login_user->id . '/account', "<i data-feather='key' class='icon-16 me-2'></i>" . app_lang('change_password'), array("class" => "dropdown-item")); ?></li>
                                <li><?php echo get_bu_contact_profile_link($login_user->id . '/my_preferences', "<i data-feather='settings' class='icon-16 me-2'></i>" . app_lang('my_preferences'), array("class" => "dropdown-item")); ?></li>
                            <?php } else { ?>
