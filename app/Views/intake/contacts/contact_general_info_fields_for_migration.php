...
<div class="form-group">
    <div class="row">
        <label for="username-<?php echo $model_info->id; ?>" class="<?php echo $label_column; ?>"><?php echo app_lang('slack_username'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(array(
                "id" => "username-$model_info->id",
                "name" => "contact_username-$model_info->id", //there has another username field on company info
...
//also check the bu login setting

if (!get_setting("disable_bu_login")) {
    ?>
    <div class="form-group">
        <div class="row">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="<?php echo $field_column; ?>">
                ...
                echo form_checkbox("is_primary_contact-$model_info->id", "1", $model_info->is_primary_contact, "id='is_primary_contact-$model_info->id' $disable class='is_primary_contact_intake form-check-input'");
                ?> 
            </div>
        </div>
    </div>
...
<?php if (!get_setting("disable_bu_login")) { ?>
    <div class="form-group ">
        <div class="row">
...
<?php echo view("intake/custom_field_migration", array("custom_fields" => $custom_fields, "label_column" => $label_column, "field_column" => $field_column, "to_custom_field_type" => "bu_contacts", "model_info" => $model_info)); ?>
