<div class="card">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php
            echo modal_anchor(get_uri("intake/add_new_contact_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_contact'), array("class" => "btn btn-default", "title" => app_lang('add_contact'), "data-post-bu_id" => $bu_id));
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#contact-table").appTable({
            source: '<?php echo_uri("intake/contacts_list_data/" . $bu_id) ?>',
            order: [[1, "asc"]],
            columns: [
                ...
                {title: "<?php echo app_lang("slack_username") ?>", "class": "w15p"},
