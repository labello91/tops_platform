<?php echo form_open(get_uri("intake/save_intake_from_excel_file"), array("id" => "import-intake-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-intake-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("intake/upload_excel_file"),
                "validation_url" => get_uri("intake/validate_import_intake_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("intake/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var $uploadArea = $("#upload-area"),
                ...
                $modalBody = $(".import-intake-modal-body"),
        ...
        function addLargeModal() {
            $ajaxModal.addClass("import-bu-app-modal");
        ...
        $submitButton.click(function () {
            $("#import-intake-form").trigger("submit");
        });
        ...
        $nextButton.click(function () {
            ...
            appLoader.show({container: ".import-intake-modal-body", css: "left:0;"});
            var $button = $(this);
            ...
            $.ajax({
                url: "<?php echo get_uri('intake/validate_import_intake_file_data') ?>",
                type: 'POST',
                dataType: 'json',
