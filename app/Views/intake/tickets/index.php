        ...
        <?php if (isset($page_type) && $page_type === "full") { ?>
            <div class="page-title clearfix">
                ...
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("tickets/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_ticket'), array("class" => "btn btn-default", "data-post-bu_id" => $bu_id, "title" => app_lang('add_ticket'))); ?>
                </div>
            </div>
        <?php } else { ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#ticket-table").appTable({
            source: '<?php echo_uri("tickets/ticket_list_data_of_bu/" . $bu_id) ?>',
            order: [[6, "desc"]],
            columns: [
