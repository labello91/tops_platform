            ...
            <div class="card">
                <div class="page-title clearfix">
                    <h4>
                        <?php
                        if ($type == "bu_default") {
                            echo app_lang('left_menu_for_bu');
                        } else {
                    ...
                    <div class="title-button-group">
                        <?php
                        if ($type == "bu_default" && get_setting("default_bu_left_menu")) {
                            echo anchor(get_uri("left_menus/restore/bu_default"), "<span data-feather='refresh-cw' class='icon-16'></span> " . app_lang("restore_to_default"), array("class" => "btn btn-danger"));
                ...
                <div class="card-body">
                    <div class="text-off pb15">
                        <?php
                        if ($type == "bu_default") {
                            echo app_lang('left_menu_setting_help_message_for_bu');
                        } else {
