<div class="rise-chat-header box">
    ...
    <div class="box-content">
        <ul class="chat-tab p0 m0 nav nav-tabs box"  data-bs-toggle="ajax-tab" role="tablist">
            ...
            <?php if ($show_bu_list) { ?>
                <li class="box-content" id="chat-bu-tab-button">
                    <a role="presentation"  href="<?php echo_uri("messages/users_list/bu"); ?>" data-bs-target="#chat-bu-tab"><i data-feather="briefcase" class="icon-16"></i></a>
                </li>
            <?php } ?>
...
<div class="rise-chat-body long clearfix">
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="chat-bu-tab"></div>
    </div>
</div>