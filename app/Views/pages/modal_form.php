...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="<?php echo $model_info->internal_use_only ? "" : "hide"; ?>" id="page-visible-to-area">
            <div class="form-group <?php echo $model_info->visible_to_bu_only ? "hide" : ""; ?>" id="visible_to_team_members_only_area">
                <div class="row">
            ...
            <div class="form-group <?php echo $model_info->visible_to_team_members_only ? "hide" : ""; ?>" id="visible_to_bu_only_area">
                <div class="row">
                    <label for="visible_to_bu_only" class=" col-md-4"><?php echo app_lang('visible_to_bu_only'); ?></label>
                    <div class=" col-md-8">
                        <?php
                        echo form_checkbox("visible_to_bu_only", "1", $model_info->visible_to_bu_only ? true : false, "id='visible_to_bu_only' class='form-check-input'");
                        ?>                       
                    </div>
                </div>
            </div> 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#visible_to_team_members_only").click(function () {
            if ($(this).is(":checked")) {
                $("#visible_to_bu_only_area").addClass("hide");
            } else {
                $("#visible_to_bu_only_area").removeClass("hide");
            }
        });

        $("#visible_to_bu_only").click(function () {
            if ($(this).is(":checked")) {
