...
if (isset($task_id)) {
    ...
    $comment_type = "file";
} else if (isset($staff_feedback_id)) {
    $comment_type = "staff_feedback";
} else {
...
<div id="<?php echo $comment_type . "-comment-form-container"; ?>">
    ...
    <div class="d-flex b-b comment-form-container">
        <div class="flex-shrink-0 d-none d-sm-block">
            <div class="avatar  <?php echo isset($project_id) || isset($staff_feedback_id) ? " avatar-md" : " avatar-sm"; ?>  pr15 d-table-cell">
        ...
        <div class="w-100">
            <div id="<?php echo $comment_type . "-dropzone"; ?>" class="post-dropzone mb-3">
                ...
                <input type="hidden" name="staff_feedback_id" value="<?php echo isset($staff_feedback_id) ? $staff_feedback_id : 0; ?>">
