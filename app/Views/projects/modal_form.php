...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <?php } else if ($login_user->user_type == "bu") { ?>
        ...
        <?php } else { ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class=" col-md-9">
                        <?php
                        echo form_dropdown("bu_id", $bu_dropdown, array($model_info->bu_id), "class='select2 validate-hidden' data-rule-required='true', data-msg-required='" . app_lang('field_required') . "'");
                        ?>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <label for="cost" class=" col-md-3"><?php echo app_lang('cost'); ?></label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "cost",
        ...
        <?php if ($model_info->id) { ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class=" col-md-9">
                        <?php
                        echo form_dropdown("status", array("open" => app_lang("open"), "completed" => app_lang("completed"), "in_progress" => app_lang("in_progress"), "hold" => app_lang("hold"), "canceled" => app_lang("canceled")), array($model_info->status), "class='select2'");
                        ?>
                    </div>
                </div>
            </div>
