...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group" style="min-height: 50px">
            <div class="row">
                <label for="user_id" class=" col-md-3"><?php echo ($add_user_type == "bu_contacts") ? app_lang('contact') : app_lang('member'); ?></label>
                <div class="col-md-9">
...
<?php if ($add_user_type == "bu_contacts") { ?>
                            $("#project-bu-contacts-table").appTable({newData: result.data[i], dataId: result.id[i]});
<?php } else { ?>
