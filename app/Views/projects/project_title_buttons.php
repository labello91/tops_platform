    ...
    <div class="dropdown btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            <?php if ($project_info->status == "open") { ?>
                ...
                <li role="presentation"><?php echo ajax_anchor(get_uri("projects/change_status/$project_info->id/in_progress"), "<i data-feather='pause-circle' class='icon-16'></i> " . app_lang('mark_project_as_in_progress'), array("class" => "dropdown-item", "title" => app_lang('mark_project_as_in_progress'), "data-reload-on-success" => "1")); ?> </li>
