    ...
    <div class="clearfix">
        ...
        <div class="p15 pt0 pr0 pl0" id="widget-row-container">
            <div class="card">
                ...
                <?php echo form_open(get_uri("dashboard/save_bu_default_dashboard"), array("id" => "dashboard-form", "class" => "general-form", "role" => "form")); ?>
...
?>;
        ...
        $("#dashboard-form").appForm({
            ...
            onSuccess: function (result) {
                ...
                window.location = "<?php echo get_uri("dashboard/bu_default_dashboard"); ?>";
            }
        });
