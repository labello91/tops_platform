            ...
            <div class="card">
                <div class="page-title clearfix">
                    ...
                    <div class="title-button-group">
                        ...
                        <?php echo anchor(get_uri("dashboard/edit_bu_default_dashboard"), "<i data-feather='columns' class='icon-16'></i> " . app_lang('edit_dashboard'), array("class" => "btn btn-default", "title" => app_lang('edit_dashboard'))); ?>
                    </div>
                </div>

                <div class="bg-off-white">
                    <div class="bu-dashboard-help-message"><?php echo app_lang("bu_dashboard_help_message"); ?></div>
    ...
    $(document).ready(function () {
        $('#restore_to_default').click(function () {
            $(this).appConfirmation({
                ...
                onConfirm: function () {
                    $.ajax({
                        url: "<?php echo get_uri('dashboard/restore_to_default_bu_dashboard') ?>",
                        type: 'POST',
                        success: function () {
                            location.reload();
                        }
