<div class="card no-border clearfix mb0">
    ...
    <div class="card-body">
        ...
        <div class="google-drive-show-hide-area <?php echo get_setting("enable_google_drive_api_to_upload_file") ? "" : "hide" ?>">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="google_drive_bu_id" class=" col-md-2"><?php echo app_lang('google_drive_bu_id'); ?></label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "google_drive_bu_id",
                            "name" => "google_drive_bu_id",
                            "value" => get_setting('google_drive_bu_id'),
                            "class" => "form-control",
                            "placeholder" => app_lang('google_drive_bu_id'),
            ...
            <div class="form-group">
                <div class="row">
                    <label for="google_drive_bu_secret" class=" col-md-2"><?php echo app_lang('google_drive_bu_secret'); ?></label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "google_drive_bu_secret",
                            "name" => "google_drive_bu_secret",
                            "value" => get_setting('google_drive_bu_secret'),
                            "class" => "form-control",
                            "placeholder" => app_lang('google_drive_bu_secret'),
                            "data-rule-required" => true,
                            "data-msg-required" => app_lang("field_required"),
                        ));
                        ?>
