                    ...
                    <div class="card bg-white clearfix">
                        ...
                        <div class="card-body p30 rounded-bottom">
                            ...
                            <?php } else { ?>
                                ...
                                <?php if ($signup_type === "new_bu" || $signup_type === "verify_email") { ?>
                                    <div class="form-group">
                                        <label for="bu_name" class="col-md-12"><?php echo app_lang('bu_name'); ?></label>
                                        <div class="col-md-12">
                                            <?php
                                            echo form_input(array(
                                                "id" => "bu_name",
                                ...
                                <?php if (get_setting("enable_gdpr") && get_setting("show_terms_and_conditions_in_bu_signup_page") && get_setting("gdpr_terms_and_conditions_link")) { ?>
                                    <div class="form-group">
                                        <div class="col-md-12">
