...
<div id="keyboard-shortcut-modal-form" class="modal-body clearfix general-form white">
    <div class="container-fluid">
        <?php if (($login_user->user_type == "team_member" && ($login_user->is_admin || get_array_value($permissions, "can_manage_all_projects") == "1" || get_array_value($permissions, "can_create_tasks") == "1")) || ($login_user->user_type == "bu" && get_setting("bu_can_create_tasks"))) { ?>
        ...
        <?php } ?>
        <?php if (get_setting("module_event") == "1" && (($login_user->user_type == "bu" && !in_array("events", $hidden_menu)) || $login_user->user_type == "team_member")) { ?>
            <div class="form-group">
                <div class="row">
        ...
        <?php } ?>
        <?php if (get_setting("module_note") == "1" && $login_user->user_type == "team_member") { ?>
            <div class="form-group">
                <div class="row">
