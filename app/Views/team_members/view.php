...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0" role="tablist">
        ...
        <?php if ($show_actuals_info) { ?>
            <li><a role="presentation" href="<?php echo_uri("team_members/actuals_info/" . $user_info->id); ?>" data-bs-target="#tab-actuals-info"><?php echo app_lang('actuals'); ?></a></li>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-actuals-info"></div>
    </div>
</div>
