    ...
    <div>
        <div>
            ...
            if ($comment->created_by == 999999999) {
                ...
                //user is an undefined bu from email
                echo "<span class='dark strong'>" . $comment->creator_name . " [" . app_lang("unknown_bu") . "]" . "</span>";
            } else {
                if ($comment->user_type === "staff") {
                    ...
                    echo get_bu_contact_profile_link($comment->created_by, $comment->created_by_user, array("class" => "dark strong"));
                }
            }
            ?>
