                    ...
                    <div class="title-button-group p10">
                        ...
                        <span class="dropdown inline-block">
                            ...
                            <ul class="dropdown-menu float-end" role="menu">
                                ...
                                <?php } ?>
                                <?php if ($ticket_info->assigned_to === "0" && $login_user->user_type == "team_member") { ?>
                                ...
                                <?php } ?>
                                <?php if ($ticket_info->bu_id === "0" && $login_user->user_type == "team_member") { ?>
                                    <?php if ($can_create_bu) { ?>
                                        <li role="presentation"><?php echo modal_anchor(get_uri("bu/modal_form"), "<i data-feather='plus' class='icon-16'></i> " . app_lang('link_to_new_bu'), array("title" => app_lang('link_to_new_bu'), "data-post-ticket_id" => $ticket_info->id, "class" => "dropdown-item")); ?></li>
                                    <?php } ?>
                                    <li role="presentation"><?php echo modal_anchor(get_uri("tickets/add_bu_modal_form/$ticket_info->id"), "<i data-feather='link' class='icon-16'></i> " . app_lang('link_to_existing_bu'), array("title" => app_lang('link_to_existing_bu'), "class" => "dropdown-item")); ?></li>
                                <?php } ?>
                            </ul>
                        </span>
                    </div>
