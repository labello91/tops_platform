<div class="tab-content">
    ...
    if ($user_info->user_type === "bu") {
        $url = "bu";
        if (isset($can_edit_bu) && !$can_edit_bu) {
            $show_submit = false;
        }
    }
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php if ($user_info->user_type === "team_member" && $login_user->is_admin) { ?>
                <div class="form-group">
                    <div class="row">
            ...
            <?php if ($login_user->is_admin && $user_info->id !== $login_user->id) { ?>
                ...
                <?php if ($user_info->user_type === "team_member") { ?>
                    <div class="form-group">
                        <div class="row">
            ...
            <?php if ($user_info->user_type === "bu" && $login_user->is_admin) { ?>
